...
public class UsbService extends Service {
    ...
    // Re-use the usb callback, but should consider making this abstract so we can reuse for
    // other serial connections.
    private UsbSerialInterface.UsbReadCallback mDaisyCallback;
